...
# ----- ТВОИ КЛЮЧИ (потом заменишь на новые) -----
TELEGRAM_TOKEN = "8968007410:AAGVB0lla-38NsNsOmdA1WAsS86YMwkUZas"
GOOGLE_API_KEY = "sk-ILvVrppDc74nfpO5-fGesA"
...
def set_voice(call):
    ...
    voice_name = [name for name, code in VOICES.items() if code == call.data][0]
...
if __name__ == "__main__":
    print("✅ Бот запущен с моделью gemini-2.5-flash-preview-tts")
